...
import { formatImageUrl, formatDatabaseImageUrl } from "../../utils/image-utils";

interface ActualiteImageGalleryModalProps {
  isOpen: boolean;
  onClose: () => void;
  images: string[];
  title: string;
...
export const ActualiteImageGalleryModal: React.FC<ActualiteImageGalleryModalProps> = ({
  isOpen,
  onClose,
  images,
  title,
