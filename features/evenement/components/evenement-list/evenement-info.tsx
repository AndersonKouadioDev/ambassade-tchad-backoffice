...
export default function EvenementInfo() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useEvenementDetailQuery(evenementId);
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Cette évènement n&#39;existe pas ou a été supprimée.
          </p>
  ...
  const selectedImage = hasImages
    ? evenement.imageUrl?.[selectedImageIndex]
    : null;
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-purple-800 dark:text-purple-100">
                      {evenement.createdAt
                        ? new Date(evenement.createdAt).toLocaleTimeString(
                            "fr-FR",
                            {
                              hour: "2-digit",
                              minute: "2-digit",
                ...
                <div className="flex items-center gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                  <div className="flex items-center justify-center w-10 h-10 bg-orange-100 dark:bg-orange-800 rounded-full">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-orange-800 dark:text-orange-100">
                      {evenement.eventDate
                        ? new Date(evenement.eventDate).toLocaleDateString(
                            "fr-FR",
                            {
                              day: "numeric",
                              month: "long",
                ...
                {evenement.updatedAt &&
                  evenement.updatedAt !== evenement.createdAt && (
                    <div className="flex items-center gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-amber-800 dark:text-amber-100">
                          {new Date(evenement.updatedAt).toLocaleDateString(
                            "fr-FR",
                            {
                              day: "numeric",
                              month: "long",
