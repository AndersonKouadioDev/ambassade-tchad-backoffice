...
import {VideoDTO, videoSchema} from "@/features/galeries/videos/schemas/video.schema";
import {useVideoCreateMutation, useVideoUpdateMutation} from "@/features/galeries/videos/queries/video.mutation";
...
export const VideoForm: React.FC<VideoFormProps> = ({
    ...
    // Hook de mutations
    const {
        mutateAsync: videoCreateMutation,
        isPending: videoCreatePending,
    } = useVideoCreateMutation();

    const {
        mutateAsync: videoUpdateMutation,
        isPending: videoUpdatePending,
