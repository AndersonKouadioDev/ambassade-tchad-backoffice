...
import {ArrowLeft, BookOpen, Calendar, Clock, Edit, Eye, Share2, Trash2,} from "lucide-react";
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Chargement de la video...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Video introuvable</h2>
                    <p className="text-gray-600 dark:text-gray-400">Cette video n&#39;existe pas ou a été supprimée.</p>
