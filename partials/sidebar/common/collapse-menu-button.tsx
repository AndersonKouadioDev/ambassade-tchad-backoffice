            ...
            >
                ...
                >
                    <Button
                        ...
                        className={cn('w-full flex-col h-auto py-1.5 px-3.5 capitalize font-semibold ring-offset-sidebar', {
            ...
            >
                <div className='peer flex items-center group [&[data-state=open]>button>div>div>svg]:rotate-180' >
                    ...
                    <Button
                        ...
                        variant={active ? "default" : "ghost"}
                        color='secondary'
                        className={cn('w-full justify-start capitalize group  h-auto py-3 md:px-3 px-3   ring-offset-sidebar group-data-[state=open]:bg-secondary ', {
